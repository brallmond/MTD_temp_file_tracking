...
class lpgbt_chip(LpgbtV1):
    ...
    def __init__(self, logger, whichL=0):
    ...
    gpio_mapping = {
       ...
       "L1": {
          "clk_preemp_conf": {"gpio_port": 0, "dir": 1},
          "elink_preemp_dur": {"gpio_port": 1, "dir": 1},
          "not_connected_1": {"gpio_port": 2, "dir": 0},
          "calib_preemp_dur": {"gpio_port": 3, "dir": 1},
          "not_connected_2": {"gpio_port": 4, "dir": 0},
          "clk_preemp_dur": {"gpio_port": 5, "dir": 1},
          "vddac_power": {"gpio_port": 6, "dir": 0},
          "not_connected_3": {"gpio_port": 7, "dir": 0},
          "elink_preemp_conf": {"gpio_port": 8, "dir": 1},
          "not_connected_4": {"gpio_port": 9, "dir": 0},
          "not_connected_5": {"gpio_port": 10, "dir": 0},
          "calib_preemp_conf": {"gpio_port": 11, "dir": 1},
          "vddad_power": {"gpio_port": 12, "dir": 0},
          "not_connected_6": {"gpio_port": 13, "dir": 0},
          "2p5v_power": {"gpio_port": 14, "dir": 0},
          "not_connected_7": {"gpio_port": 15, "dir": 0},
       },

       "L0": {
          "not_connected_1": {"gpio_port": 0, "dir": 0},
          "not_connected_2": {"gpio_port": 1, "dir": 0},
          "clk_preemp_conf": {"gpio_port": 2, "dir": 1},
          "elink_preemp_dur": {"gpio_port": 9, "dir": 1},
          "calib_preemp_dur": {"gpio_port": 7, "dir": 1},
          "clk_preemp_dur": {"gpio_port": 10, "dir": 1},
          "vddaa_power": {"gpio_port": 3, "dir": 0},
          "elink_preemp_conf": {"gpio_port": 8, "dir": 1},
          "calib_preemp_conf": {"gpio_port": 6, "dir": 1},
          "vddab_power": {"gpio_port": 5, "dir": 0},
          "1p2v_power": {"gpio_port": 4, "dir": 0},
          "not_connected_3": {"gpio_port": 11, "dir": 0},
          "not_connected_4": {"gpio_port": 12, "dir": 0},
          "not_connected_5": {"gpio_port": 13, "dir": 0},
          "not_connected_6": {"gpio_port": 14, "dir": 0},    
          "not_connected_7": {"gpio_port": 15, "dir": 0},
      },
    }
    ...
    adc_mapping = {
           ...
           "L1": {
              "fe12_sipm_temp1": {"adc_port": 0, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0 },
              "fe12_sipm_temp2": {"adc_port": 1, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
              "pccB_temp1": {"adc_port": 2, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
              "pccB_temp2": {"adc_port": 3, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
              "vddac_voltage": {"adc_port": 4, "cur_mask": 0, "gain": 0 , "neg_ref":15, "unit":"volts", "slope":1.0, "offset":0},
              "vddad_voltage": {"adc_port": 5, "cur_mask": 0, "gain": 0 , "neg_ref":15, "unit":"volts", "slope":1.0, "offset":0},
              "ccboard_temp2": {"adc_port": 6, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
              "ccboard_temp3": {"adc_port": 7, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
           },
    
           "L0": {
              "fe6_sipm_temp1": {"adc_port": 0, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
              "fe6_sipm_temp2": {"adc_port": 1, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
              "pccA_temp1": {"adc_port": 2, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
              "pccA_temp2": {"adc_port": 3, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
              "vddaa_voltage": {"adc_port": 4, "cur_mask": 0, "gain": 0 , "neg_ref":15, "unit":"volts", "slope":1.0, "offset":0},
              "vddab_voltage": {"adc_port": 5, "cur_mask": 0, "gain": 0 , "neg_ref":15, "unit":"volts", "slope":1.0, "offset":0},
              "vin_voltage": {"adc_port": 6, "cur_mask": 0, "gain": 0 , "neg_ref":15, "unit":"volts", "slope":1.0, "offset":0},
              "ccboard_temp1": {"adc_port": 7, "cur_mask": 1, "gain": 0 , "neg_ref":15, "unit":"deg C", "slope":1.0, "offset":0},
           },
    ...
    # ADC setup and read
    def mk_default_current_mask(self):
       num = 0
       for key in self.adc_mapping[self.whichL].keys():
          num |= self.adc_mapping[self.whichL][key]["cur_mask"] << self.adc_mapping[self.whichL][key]["adc_port"]

       return num 

    def set_adc(self):
       # Lpgbt 0 (address 0x70): 0b10001111 whichL = "L0"
       # Lpgbt 1 (address 0x71): 0b11001111 whichL = "L1"
       # 0 = not enabled, 1 = enabled

       #if self.whichL == "L1":  current_dac_mask = "0b11001111"
       #elif self.whichL == "L0":  current_dac_mask = "0b10001111"
       
       self.cdac_setup(1, self.mk_default_current_mask(), enable = True) # first argument should be changed, it's just a random for test

    def read_adc(self, thesensor):
       map_ = self.adc_mapping[self.whichL][thesensor]
       pos_in = map_["adc_port"]
       neg_in = map_["neg_ref"]
       gain_ = map_["gain"]
       #assert map_["cur_mask"] == 1 , "The port {} for sensor {} is not enabled (current mask = {})".format(pos_in, thesensor, map_["cur_mask"])

       self.adc_config(pos_in, neg_in, gain_)
       return self.adc_convert()



    
    def mk_default_direction(self):
       num = 0
       for key in self.gpio_mapping[self.whichL].keys():
          num |= self.gpio_mapping[self.whichL][key]["dir"] << self.gpio_mapping[self.whichL][key]["gpio_port"]

       return num 

    def set_gpio_direction(self):

       # Lpgbt 0 (address 0x70): 0b0000001111000100 isL1=False
       # Lpgbt 1 (address 0x71): 0b0000100100101011 isL1=True
       # 0 = input / read, 1 = output / write 
        
       # if self.whichL == "L1": self.gpio_set_dir(0b0000100100101011)
       # elif self.whichL == "L0": self.gpio_set_dir(0b0000011111000100) # in the ccv2.0 Table 7 has 17 entries instead of 16. Entries 0 and 16 are not connected
       # print("---> Done gpio direction configuration")
       
       self.gpio_set_dir(self.mk_default_direction())
       print("---> Done gpio direction configuration")

    def read_gpio_output(self, thefunction):
        
       map_ = self.gpio_mapping[self.whichL][thefunction]
       bit_ = map_["gpio_port"]
       assert map_["dir"] == 1 , "The port {} for function {} is not in output state (dir = {})".format(bit_, thefunction, map_["dir"])

       return self.gpio_get_out_bit(bit_)

    def write_gpio_output(self, thefunction, value):
       
       assert value in [0,1] , "Input value not in 0,1... value={}".format(value)
       map_ = self.gpio_mapping[self.whichL][thefunction]
       bit_ = map_["gpio_port"]
       assert(map_["dir"] == 1), "The port {} for function {} is not in output state (dir = {})".format(bit_, thefunction, map_["dir"])

       self.gpio_set_out_bit(bit_, value)
    
    def read_gpio_input(self, thefunction):

        map_ = self.gpio_mapping[self.whichL][thefunction]
        bit_ = map_["gpio_port"]

        assert map_["dir"] == 0, "The port {} for function {} is not in input state (dir = {})".format(bit_, thefunction, map_["dir"])

        return self.gpio_get_in_bit(bit_)

    
    def set_gpio_bit_direction(self, thefunction, dir_=0):

        map_ = self.gpio_mapping[self.whichL][thefunction]
        bit_ = map_["gpio_port"]
        
        assert map_["dir"] == 1, "The port {} is an input port (dir = {}). The direction can be changed only for pins of output type)".format(bit_, map_["dir"])
        
        self.gpio_set_dir_bit(bit_, dir_)

    def get_gpio_bit_direction(self, thefunction):
    
        return self.gpio_get_dir_bit(self.gpio_mapping[self.whichL][thefunction]["gpio_port"])

    def get_gpio_direction(self):

        return self.gpio_get_dir()
   
    
    def check_ROM_stability(self):
       
       print("---> Start") 

       for i in range(16):
          print("---> ROM: ", self.read_reg(self.ROM))
          time.sleep(0.5)
          print("")
